...
{
public:
    EnvelopePanel() : tabbedComponent(juce::TabbedButtonBar::TabsAtTop)
    {
        for (int i = 1; i <= 4; ++i)
        {
            ...
            tabbedComponent.addTab("ENV " + juce::String(i), 
...
private:
    ...
    std::vector<std::unique_ptr<juce::Component>> envelopePanels;
